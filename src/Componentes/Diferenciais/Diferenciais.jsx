...
export default function Diferenciais() {
    ...
    return(
        <div className='diferenciais' id='diferenciais'>
            ...
            <div className='diferenciais-mobile'>
                <div className='diferenciais-mobile__titulos'>
                    <h4 className='diferenciais-mobile__subtitulo'>Motivos para nos escolher</h4>
                    <h1 className='diferenciais-mobile__titulo'>Alguns diferenciais</h1>
                </div>
                <div className='diferenciais__itens'>
                    <div className='diferenciais__item'>
                        <div className='item'>
